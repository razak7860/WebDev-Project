      ...
      <div className="flex gap-15 justify-between items-center  w-full">
        <div className="w-[45%] flex flex-col   gap-5">
          {timeline.map((element, index) => {
            return (
              <div className="flex gap-6 key={index}  items-center">
        ...
        <div className="relative shadow-blue-200 ">
          ...
          />
          <div className="absolute bg-caribbeangreen-700 flex text-white uppercase py-10 border left-[50%] translate-x-[-50%] translate-y-[-50%]">
